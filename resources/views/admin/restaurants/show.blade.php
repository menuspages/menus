        ...
        <div class="d-flex justify-content-between mt-4">
            ...
            <div class="d-flex">
                <button class="btn btn-sm btn-outline-secondary mr-3"
                        onclick="window.location = '{{route('edit-restaurant', $restaurant->subdomain)}}'">
                    تعديل
                ...
                <form action="{{route('delete-restaurant',$restaurant->subdomain)}}" method="POST" id="delete-form">
                    @method('delete')
                    @csrf()
                </form>
            </div>
        ...
        <div class="col-lg-6 col-md-12">
            <dl class="row">
                ...
                <dd class="col-sm-7 mt-2">
                    <img src="{{$restaurant->logoUrl()}}" alt="{{$restaurant->name}}" class="details-image"
                         aria-view="true">
                </dd>

                @if($restaurant->background_image_path)
                    <dt class="col-sm-5 mt-2">صورة خلفية المتجر</dt>
                    <dd class="col-sm-7 mt-2">
                ...
                <dt class="col-sm-5 mt-2">مدير المتجر</dt>
                <dd class="col-sm-7 mt-2">
                    @if(isset($restaurant->manager))
                        <td><a href="/users/{{$restaurant->manager->id}}">{{ $restaurant->manager->name}}</a></td>
                    @else
                        <td>ﻻ يوجد</td>
                    @endif
                </dd>
                ...
                <dd class="col-sm-7 mt-2">{{$restaurant->created_at}}</dd>

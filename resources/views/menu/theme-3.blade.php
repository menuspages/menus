...
<link rel="stylesheet" href="{{asset('css/theme-3.css'). '?_=' . config('app.version_date')}}">
        ...
        <div class="container-fluid  justify-content-center  flex-column" id="items-container" v-cloak>
            ...
            <div class="mt-4 justify-content-center  item collapse text-center"  id="a{{$category->id}}">
                <div class="items-container">
                    ...
                    <div  class="bg-white border-radius-10 my-2 position-relative  {'{{(!$item->is_available) ? '': ''}}': true, 'added': typeof cart[{{$item->id}}] !== 'undefined'}">
                    ...
                    <div class="item-wrapper position-relative d-flex">
                                ...
                                <div>
                                    ...
                                    <div class="description" >
                                           @foreach(explode('/', $item->description) as $info)
                                                <label class="line-height" > {{$info}} </label>
                                                <br>
                                            @endforeach
                                    </div>  
                           ...
                           <div>
                            ...
                            <div class="btn-sub-details" >
                                ...
                                @else 
                                    <div class="btn-add-to-cart place-order d-flex justify-content-left align-items-center" >
                                        @include('layouts.menu-partials.sub_details') 
